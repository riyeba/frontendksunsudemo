...
//                   </td> 
//                   <td>
//                     <Link to={`/sboardf/${el.id}`} className="text-decoration-none" style={{cursor:'pointer'}}>
//                       {el.First_name}
//                     </Link>
//                   </td>
    ...
    <div className="container mt-3 min-vh-100">
      {isLoading ? (
        ...
        <div>
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center">
              <h3 className="mb-0">Female Active Students</h3>
              <Link to="/admin" className="text-decoration-none text-black fw-bold">
                <h2 className="mb-0 ">
                  <i className="bi bi-arrow-left"></i>
                </h2>
            ...
            <tbody>
              {active.slice(startIndex, endIndex).map((el) => (
                <tr key={el.id}>
                  ...
                  <td>
                    <Link to={`/sboardf/${el.id}`} className="text-decoration-none">  
                      {el.First_name}
                    </Link>
                  </td>
                  <td>{el.Phone_number}</td>
