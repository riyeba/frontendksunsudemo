...
function StudentsDashboardadmin() {
          ...
          <div className="card">
            ...
            <div className="p-2 ">
              ...
              <div className="d-flex gap-1">
                {dash?.FamilyinSaudi=="Yes"? <p className="flex-shrink-1">Address :</p> : <p className="flex-shrink-1">Building :</p>}
                {/* <p>{dash?.Address=="undefined"? "Nil" : dash?.Address}</p> */}
                {dash?.FamilyinSaudi=="Yes"? (<p>{dash?.Address}</p>) : (<p>{dash?.Building_number}/{dash?.Room_number}</p>)}
              </div>
            </div>
          </div>
...
export default StudentsDashboardadmin;
