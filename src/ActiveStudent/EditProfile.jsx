...
function EditProfile() {
  ...
  async function Submit() {
    ...
    formdata.append("email_sent_condition_met", false);
    ...
    try {
      ...
      const response = await axios.put(`https://taiwoakinpennu2.pythonanywhere.com/nsu/${id}/`, formdata);
        ...
        <div className="card">
          ...
          <div className="mb-3">
              ...
              >
                ...
                <option value={el?.Gender}>{el?.Gender}</option>
              </select>
            </div>
            <div className="mb-3">
