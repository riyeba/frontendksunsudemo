...
function SignIn() {
  ...
  function handleSubmit(e) {
    ...
    axios
      .post("https://taiwoakinpennu2.pythonanywhere.com/login/", formData, {
    ...
    <form className="container w-auto mt-5 min-vh-100" onSubmit={handleSubmit}>
      ...
      <div className="card">
        ...
        <div className="container">
          ...
          <p>
            Need an account? <Link to='/register' className="text-decoration-underline cursor-pointer text-dark"> <strong>Sign up</strong></Link>
          </p>
          <p>
            Forgot Password? <Link to='/password' className="text-decoration-underline cursor-pointer text-dark"><strong>Reset it</strong></Link>
          </p>
        </div>
      </div>
    </form>
