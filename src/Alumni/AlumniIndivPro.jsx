...
function AlumniDashBoardAl() {
  ...
  useEffect(() => {
    try {
      axios
        .get(`https://taiwoakinpennu2.pythonanywhere.com/nsual/${params.member_idalumnii}/`)
        .then((response) => {
          ...
          <div>
            ...
            <div className="list-group list-group-flush ">
              <div className="list-group-item list-group-item-action d-flex gap-2  ">
                ...
                <Link to="/boardal" className="text-black text-decoration-none">
                  My Dashboard
                </Link>
              </div>
            </div>
...
export default AlumniDashBoardAl;
