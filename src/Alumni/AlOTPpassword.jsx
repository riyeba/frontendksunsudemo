...
const navigate=useNavigate()
  ...
  function handleSubmit(e) {
    ...
    axios
      .post("https://taiwoakinpennu2.pythonanywhere.com/alverify/", formdata, {
  ...
  return (
    ...
    <div className="card">
      ...
      <Link to='/boardal'><button type="submit" className="btn mb-3 btn-danger" >
        Cancel
      </button></Link>
