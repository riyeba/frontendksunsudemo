...
//               <Link to="/students" className="text-decoration-none text-black fw-bold">
//                 <h2 className="mb-0 ">
...
// export default ActiveStudents2;
            ...
            <tbody>
              {active.slice(startIndex, endIndex).map((el) => (
                <tr key={el.id}>
                  ...
                  <td>
                    <Link to={`/sboardmale/${el.id}`} className="text-decoration-none">
                      {el.First_name}
                    </Link>
                  </td>
                  <td>{el.Phone_number}</td>
